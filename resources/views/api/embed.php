...
<?php echo ( isset($_GET["nofont"]) ? "" : '<link rel="stylesheet" href="https://indestructibletype.com/fonts/Jost.css" type="text/css" charset="utf-8" />' ); ?>
...
<div id="code">
    ...
    <div id="toolbar">
        ...
        <a target="_blank" id="powered_by" href="https://pastefy.ga/<?php echo htmlspecialchars( $paste["id"] ); ?>">Powered by <img id="pastefy_logo" src="/assets/images/logo.png" ></a>
    </div>
</div>
<style>
    * {
